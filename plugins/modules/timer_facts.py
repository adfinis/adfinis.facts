...
class SystemctlScanService(BaseService):
    ...
    def gather_timers(self):
        ...
        for line in [tmr_line for tmr_line in stdout.split('\n') if '.timer' in tmr_line]:
            ...
            self.module.log(msg="Timer 1 %s" % line)
            state_val = "stopped"
            status_val = "unknown"
            fields = line.split()
            ...
            self.module.log(msg="Test 1 %s" % timer_name)
        ...
        for line in [tmr_line for tmr_line in stdout.split('\n') if '.timer' in tmr_line]:
            ...
            self.module.log(msg="Timer 2 %s" % line)
            try:
